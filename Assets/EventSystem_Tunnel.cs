...
{
    [SerializeField] List<Tunnel> elementer = new List<Tunnel>();
    ...
    private ItemStatus.errorColor GetRandomErrorColor()
    {
        ...
        switch (r)
        {
            ...
            case 2: return ItemStatus.errorColor.blue;
